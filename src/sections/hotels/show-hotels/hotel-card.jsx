...
//                     className={
//                       "relative w-full !text-black hover:!no-underline"
//                     }
//                   >
...
//                             {event?.event_associated_amenities?.length}{" "}
//                             Amenities
//                           </span>
//                         </Typography>
...
//       <div className="mt-5 space-y-5">
//         {isLoading ? (
//           // Render the skeleton loaders if the data is still loading
//           [1, 2, 3, 4].map((_, index) => <EventCardSkeleton key={index} />)
//         ) : hotelEvents && hotelEvents.length > 0 ? (
//           // Render hotel events if loading is finished and there are events
//           hotelEvents.map((event) => (
//             <Card
//               key={event?.id}
//               className="p-0 overflow-hidden rounded-xl shadow-md border cursor-pointer"
...
//           ))
//         ) : (
//           // Render the NoEvents component if there are no hotel events
//           <NoEvents message={"No Hotel Events Found"} />
//         )}
//       </div>
//     </>
