...
export const Footer = () => {
  return (
    <div className="flex flex-col w-full h-full">
      ...
      <div className="relative flex lg:flex-row flex-col xl:gap-16 lg:gap-x-8 md:gap-x-10 gap-y-6 bg-footer bg-cover bg-no-repeat z-10 py-10 md:py-16 items-start px-5 sm:px-8 lg:px-14 xl:px-20 ">
