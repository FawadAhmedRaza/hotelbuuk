...
export const Booking = React.memo(() => {
  return (
    <div className=" flex flex-col md:flex-row gap-5 md:gap-0 items-center w-11/12 lg:w-10/12 h-fit rounded-3xl shadow-lg p-5 sm:py-10  sm:px-10  -mt-20 !z-30 bg-white mx-auto mb-10">
