  ...
  return (
    <div className="w-full relative">
      ...
      <BgIcon
        ...
        iconClass="!size-4"
        className="swiper-button-prev custom-prev absolute -left-5 md:-left-8 lg:-left-8 bg-primary size-8 z-30 top-1/2 md:top-1/2 -translate-y-1/2"
      />
      ...
      <BgIcon
        ...
        iconClass="!size-4"
        className="swiper-button-next custom-next absolute -right-5 md:-right-8 lg:-right-8 bg-primary size-8 z-30 top-1/2 md:top-1/2 -translate-y-1/2"
      />
