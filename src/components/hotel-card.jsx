...
// import { createWishList, getWishById } from "../redux/wishlist/thunk";
...
//     if (user && event) {
//       // Only fetch if user and event are defined
//       fetchWish();
//     }
//   }, [user, event, dispatch]); // Include dependencies to rerun if they change
